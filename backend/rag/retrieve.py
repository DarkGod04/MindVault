...
def load_vectorstore():
    ...
    vectorstore_path = "vectorstore_gemini"
...
def generate_answer(question: str, docs, mode: str = "default", history: list = []):
    primary = ChatGoogleGenerativeAI(model="gemini-3.5-flash", temperature=0.2)
    fallbacks = [
        ...
        ChatGoogleGenerativeAI(model="gemini-2.0-flash", temperature=0.2),
